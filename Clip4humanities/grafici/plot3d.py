...
# Riduzione dimensionale con PCA per la visualizzazione 3D
pca = PCA(n_components=3)
reduced_embeddings = pca.fit_transform(embeddings)

# Creazione di un DataFrame per la visualizzazione
visualization_df = pd.DataFrame(reduced_embeddings, columns=['PCA1', 'PCA2', 'PCA3'])
...
fig = px.scatter_3d(
    ...
    color='label',
    hover_data=['filename'],
    title='3D Image Clusters Visualization'
)
...
fig.write_html("image_clusters_3d.html")
